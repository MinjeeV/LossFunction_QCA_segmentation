...
#     @autocast()
    def forward(self,x):
        ...
        # classification
        _class = self.classification_head(hx6)
        ...
        return [torch.sigmoid(d0), torch.sigmoid(d1), torch.sigmoid(d2), torch.sigmoid(d3), torch.sigmoid(d4), torch.sigmoid(d5), torch.sigmoid(d6)], _class
